...
print("init_time_sinh={}".format(init_time))
print("query_all_time_sinh={}".format(query_all_time))
print("query_one_time_sinh={}".format(query_one_time))
print("query_pair_time_sinh={}".format(query_pair_time))
print("memory_consumption_sinh={}".format(memory_consumption_diff_sketch_size))
print("accuracy_diff_sketch_size_sinh={}".format(accuracy_diff_sketch_size))
...
print("init_time_sinh_diff_D={}".format(init_time))
print("query_all_time_sinh_diff_D={}".format(query_all_time))
print("query_one_time_sinh_diff_D={}".format(query_one_time))
print("query_pair_time_sinh_diff_D={}".format(query_pair_time))
