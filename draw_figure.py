...
query_pair_time_exp_std_err=[0.07597239843403948, 0.07427881858130388, 0.07421324997184156, 0.07336590911283035, 0.06973385853981534, 0.06914465114325063, 0.09385647903969015]
...
init_time_exp_diff_D_std_err=[0.01752736407302075, 0.017576323179815657, 0.03174170919846853, 0.03473566388175236, 0.04203341937381655, 0.21728834791122836, 0.12543344635608955]
query_all_time_exp_diff_D_std_err=[0.005481068187558333, 0.010464805052117252, 0.015412998467154004, 0.01703686063423625, 0.02356038098275461, 0.029818689717398067, 0.03776654462224178]
query_pair_time_exp_diff_D_std_err=[0.0028774298866760485, 0.029041257724157454, 0.054498366776687235, 0.07449628727769904, 0.09150925807414206, 0.13097185989502141, 0.13061085690554783]
accuracy_diff_D_exp_std_err=[0.011533049885196798, 0.043478153907372495, 0.04832163688892441, 0.11239930752796916, 0.07584960435355921, 0.1420382635540066, 0.07871864286620743]
...
query_pair_time_cosh_std_err=[0.06285678224260585, 0.065336614086169, 0.06368513938539208, 0.06437937613825098, 0.062446916694571745, 0.06370601912698873, 0.08825878249872315]
...
query_pair_time_cosh_diff_D_std_err=[0.002224777938902467, 0.023365716742834615, 0.048386442103557185, 0.0568882647217306, 0.0853706433395755, 0.13263730550042996, 0.12974277456161712]
...
query_pair_time_sinh_std_err=[0.06454952047940726, 0.09252678396940527, 0.06472432776064355, 0.06399015215620685, 0.05829939190265268, 0.07367141287716807, 0.08972869596550795]
...
query_pair_time_sinh_diff_D_std_err=[0.0019600713733240018, 0.018245476663663707, 0.04906393649141779, 0.06086297181211629, 0.08489361513482316, 0.12841056376139506, 0.13012240855911497]
...
query_pair_time_power_std_err=[0.08892260210222047, 0.08867123171511224, 0.08852709030494985, 0.08848458091828545, 0.08333966239352578, 0.06705168501090865, 0.10107737030770657]
...
query_pair_time_power_diff_D_std_err=[0.009823059176925527, 0.03763927505180809, 0.05728769069746274, 0.08232757875662075, 0.10425573287190108, 0.13502587813625494, 0.13369866195715074]
...
plt.figure()
plt.errorbar(x, tilde_fA_f_norm_error, label = "Frobenius Norm", marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.errorbar(x, tilde_fA_spetral_norm_error, label = "Spectral Norm", marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
...
plt.figure()
plt.errorbar(x, init_time_exp, yerr=init_time_exp_std_err, label='Init time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
...
# plt.show()
plt.figure()
plt.errorbar(x, query_all_time_exp, yerr=query_all_time_exp_std_err, label='QueryAll time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
# plt.figure()
# plt.errorbar(x, query_one_time_exp, label='QueryOne time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
# plt.xlabel("Sketch Size", fontsize= ticks_size)
...
# plt.show()
plt.figure()
plt.errorbar(x, query_pair_time_exp, yerr=query_pair_time_exp_std_err, label='QueryPair time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.figure()
plt.errorbar(x, memory_consumption_exp, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
...
plt.figure()
plt.errorbar(x, accuracy_diff_sketch_size_exp, yerr=accuracy_diff_sketch_size_exp_std_err, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
...
plt.figure()
plt.errorbar(x, init_time_exp_diff_D, yerr=init_time_exp_diff_D_std_err, label='Init time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
...
# plt.show()
plt.figure()
plt.errorbar(x, query_all_time_exp_diff_D, yerr=query_all_time_exp_diff_D_std_err, label='QueryAll time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
# plt.figure()
# plt.errorbar(x, query_one_time_exp_diff_D, label='QueryOne time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
# plt.xlabel("Truncation Degree", fontsize= ticks_size)
# plt.ylabel("Time (ms)", fontsize= ticks_size)
# plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
# plt.yticks(fontsize=ticks_size)
...
# plt.show()
plt.figure()
plt.errorbar(x, query_pair_time_exp_diff_D, yerr=query_pair_time_exp_diff_D_std_err, label='QueryPair time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.figure()
plt.errorbar(x, memory_consumption_exp_diff_D, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Mem Usage(MB)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
x = np.linspace(0, len(accuracy_diff_D_exp), len(accuracy_diff_D_exp))
plt.figure()
plt.errorbar(x, accuracy_diff_D_exp, yerr=accuracy_diff_D_exp_std_err, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Accuracy", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, init_time_cosh, yerr=init_time_cosh_std_err, label='Initialize time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.figure()
x = np.linspace(0, len(init_time_cosh), len(init_time_cosh))
plt.errorbar(x, query_all_time_cosh, yerr=query_all_time_cosh_std_err, label='QueryAll time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
# plt.errorbar(x, query_one_time_cosh, label='QueryOne time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
# plt.xlabel("Sketch Size", fontsize= ticks_size)
# plt.ylabel("Time (ms)", fontsize= ticks_size)
# plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
# plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, query_pair_time_cosh, yerr=query_pair_time_cosh_std_err, label='QueryPair time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, memory_consumption_cosh, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Mem Usage(MB)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, accuracy_diff_sketch_size_cosh, yerr=accuracy_diff_sketch_size_cosh_std_err, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Accuracy", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.figure()
plt.errorbar(x, init_time_cosh_diff_D,  yerr=init_time_cosh_diff_D_std_err, label='Init time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
...
plt.errorbar(x, query_all_time_cosh_diff_D, yerr=query_all_time_cosh_diff_D_std_err, label='QueryAll time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
# plt.legend(loc='upper left', fontsize=15)
...
# plt.errorbar(x, query_one_time_cosh_diff_D,  label='QueryOne time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
...
plt.errorbar(x, query_pair_time_cosh_diff_D, query_pair_time_cosh_diff_D_std_err, label='QueryPair time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
# plt.legend(loc='upper left', fontsize=15)
...
plt.errorbar(x, memory_consumption_cosh_diff_D, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Mem Usage(MB)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, accuracy_diff_D_cosh, accuracy_diff_D_cosh_std_err, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Accuracy", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, init_time_sinh, yerr=init_time_sinh_std_err, label='Init time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
x = np.linspace(0, len(init_time_sinh), len(init_time_sinh))
plt.errorbar(x, query_all_time_sinh, yerr=query_all_time_sinh_std_err, label='QueryAll', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
# plt.errorbar(x, query_one_time_sinh,   label='QueryOne time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
...
plt.figure()
plt.errorbar(x, query_pair_time_sinh, yerr=query_pair_time_sinh_std_err, label='QueryPair time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, memory_consumption_sinh, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Mem Usage(MB)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, accuracy_diff_sketch_size_sinh, yerr=accuracy_diff_sketch_size_sinh_std_err, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Accuracy", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, init_time_sinh_diff_D, yerr=init_time_sinh_diff_D_std_err ,label='Init time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, query_all_time_sinh_diff_D, yerr=query_all_time_sinh_diff_D_std_err, label='QueryAll', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
# plt.errorbar(x, query_one_time_sinh_diff_D , label='QueryOne time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
# # plt.errorbar(x, query_pair_time_sinh, label='QueryPair time')
# plt.xlabel("Truncation Degree", fontsize= ticks_size)
# plt.ylabel("Time (sec)", fontsize= ticks_size)
# plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
...
plt.figure()
plt.errorbar(x, query_pair_time_sinh_diff_D, yerr=query_pair_time_sinh_diff_D_std_err, label='QueryPair time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x,[0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, memory_consumption_sinh_diff_D , marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Mem Usage(MB)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, accuracy_diff_D_sinh, yerr=accuracy_diff_D_sinh_std_err, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Accuracy", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, init_time_power1, yerr=init_time_power_std_err, label='Init time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
x = np.linspace(0, len(init_time_power1), len(init_time_power1))
plt.errorbar(x, query_all_time_power1, yerr=query_all_time_power_std_err, label='QueryAll time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
# plt.errorbar(x, query_one_time_power1,label='QueryOne time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
# plt.xlabel("Sketch Size", fontsize= ticks_size)
# plt.ylabel("Time (sec)", fontsize= ticks_size)
# plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
# plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, query_pair_time_power1, yerr=query_pair_time_power_std_err, label='QueryPair time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, memory_consumption_power1, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Mem Usage(MB)", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, accuracy_diff_sketch_size_power, yerr=accuracy_diff_sketch_size_power_std_err, marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Sketch Size", fontsize= ticks_size)
plt.ylabel("Accuracy", fontsize= ticks_size)
plt.xticks(x, [10, 20, 40, 80, 160,320,1000], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, init_time_power_diff_D, yerr=init_time_power_diff_D_std_err,  label='Init time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
x = np.linspace(0, len(init_time_power1), len(init_time_power1))
plt.errorbar(x, query_all_time_power_diff_D, yerr=query_all_time_power_diff_D_std_err , label='QueryAll time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (ms)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
# plt.errorbar(x, query_one_time_power_diff_D,   label='QueryOne time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
# plt.xlabel("Truncation Degree", fontsize= ticks_size)
# plt.ylabel("Time (sec)", fontsize= ticks_size)
# plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
# plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, query_pair_time_power_diff_D, yerr=query_pair_time_power_diff_D_std_err, label='QueryPair time', marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Time (sec)", fontsize= ticks_size)
plt.xticks(x,[0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.errorbar(x, memory_consumption_power_diff_D,    marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Mem Usage(MB)", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
...
plt.figure()
plt.errorbar(x, accuracy_diff_D_power, yerr=accuracy_diff_D_power_std_err,  marker='o', markersize=3,capsize=5, ecolor = 'red', elinewidth = 3)
plt.xlabel("Truncation Degree", fontsize= ticks_size)
plt.ylabel("Accuracy", fontsize= ticks_size)
plt.xticks(x, [0,1,2,3,5,10,20], fontsize= ticks_size)
plt.yticks(fontsize=ticks_size)
